    ...
    : QFrame(parent), s(scale)
{
    ...
    QPushButton *bulkTasksBtn = new QPushButton(QStringLiteral("Провести задачи"), header);
    bulkTasksBtn->setCursor(Qt::PointingHandCursor);
    bulkTasksBtn->setFixedSize(s(200), s(50));
    bulkTasksBtn->setStyleSheet(QString(
        "QPushButton{background-color:#059669;border-radius:%1px;font-family:Inter;"
        "font-size:%2px;font-weight:800;color:white;padding:0 12px;}"
    ...
    connect(bulkTasksBtn, &QPushButton::clicked, this, &ListAgvInfo::bulkCompleteTasksRequested);
    hdr->addWidget(bulkTasksBtn, 0, Qt::AlignRight);
