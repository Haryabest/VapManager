...
public:
    ...
    bool isDraftFocused() const;
    void setDraft(const QString &text, bool setFocus);
...
private:
    ...
    QString cachedSenderDisplayName_;
    int cachedThreadLoadedId_ = 0;
    QString cachedThreadCreatedBy_;
    QString cachedThreadRecipientUser_;
