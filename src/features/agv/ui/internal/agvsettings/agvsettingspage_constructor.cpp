    ...
    : QWidget(parent), s(scale)
{
    ...
    QPushButton *completeAllTasksBtn = new QPushButton("Провести все задачи", this);
    completeAllTasksBtn->setFixedSize(s(240), s(45));
    completeAllTasksBtn->setStyleSheet(QString(
        "QPushButton { background-color:#059669; border-radius:%1px; font-family:Inter; font-size:%2px; font-weight:800; color:white; }"
        "QPushButton:hover { background-color:#047857; }"
    ).arg(s(10)).arg(s(14)));
    connect(completeAllTasksBtn, &QPushButton::clicked, this, &AgvSettingsPage::completeAllTasks);
    ...
    bottomBar->addWidget(completeAllTasksBtn, 0, Qt::AlignLeft);
